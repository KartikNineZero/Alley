    ...
    def setupButtons(self):
        ...
        for i in range(num_divisions):
            ...
            if i == 0:
                ...
                calculator_icon_actual_size = calculator_icon.actualSize(QSize(50, 50))  
                ...
                notes_icon_actual_size = notes_icon.actualSize(QSize(50, 50))  
                ...
                button = QPushButton(self)
                feature5_icon = QIcon("Icons/screenwheeln.svg")  
                feature5_icon_actual_size = feature5_icon.actualSize(QSize(50, 50)) 
                ...
                button = QPushButton(self)
                feature6_icon = QIcon("Icons/probot.svg")  
                feature6_icon_actual_size = feature6_icon.actualSize(QSize(50, 50))  
                button.setIcon(feature6_icon)
                button.setIconSize(feature6_icon_actual_size)
                button.setStyleSheet("background-color: none; border: none; padding: 0px;")
                button.clicked.connect(self.main_window.open_chatbot_overlay)  
                button.setToolTip("Chatbot")
            elif i == 4:
                button = QPushButton(self)
                feature7_icon = QIcon("Icons/screenshotn.svg")  
                feature7_icon_actual_size = feature7_icon.actualSize(QSize(50, 50))  
                ...
                button = QPushButton(self)
                feature9_icon = QIcon("Icons/gamep.svg")  
                feature9_icon_actual_size = feature9_icon.actualSize(QSize(50, 50)) 
                button.setIcon(feature9_icon)
                button.setIconSize(feature9_icon_actual_size)
                button.setStyleSheet("background-color: none; border: none; padding: 0px;")
                button.clicked.connect(self.feature_9_function)
